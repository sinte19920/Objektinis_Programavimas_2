...
// funkcija, apskaiciuojanti mediana arba vidurki
void med_vid(int n, int nd, deque<Studentas> &studentai, string &vidurkis_mediana, deque<Studentas> &neislaike, deque<Studentas> &islaike)
{
    double vid = 0;
    if (vidurkis_mediana == "vid")
    {
...
void duomenu_nuskaitymas(deque<Studentas> &studentai)
{
    srand(time(NULL));
    Studentas studentas;
...
// funkcija, apskaiciuojanti mediana arba vidurki
void med_vid(int n, int nd, list<Studentas> &studentai, string &vidurkis_mediana, list<Studentas> &neislaike, list<Studentas> &islaike)
{
    double vid = 0;
    if (vidurkis_mediana == "vid")
    {
...
void duomenu_nuskaitymas(list<Studentas> &studentai)
{
    srand(time(NULL));
    Studentas studentas;
